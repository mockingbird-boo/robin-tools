...
import cn.com.mockingbird.robin.common.util.string.StringCamelUtils;
    ...
    public static <T> QueryWrapper<T> entity2Wrapper(T entity) {
        ...
        try {
            ...
            for (Field field : fields) {
                ...
                // 获取字段的 get 方法
                Method method = entityClass.getMethod("get" + cn.com.mockingbird.robin.common.util.string.StringUtils.upperTheFirstChar(fieldName));
                // 执行 get 方法获取对象字段值
